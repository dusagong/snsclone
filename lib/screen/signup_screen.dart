...
import 'package:instagramclone/util/dialog.dart';
import 'package:instagramclone/util/exception.dart';
import 'package:instagramclone/util/imagepicker.dart';
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            InkWell(
              onTap: ()async{
                File _imagefile = await Imagepickerr().uploadImage('camera');
                setState(() {
